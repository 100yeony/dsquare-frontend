...
export default {
  ...
  methods: {
    ...
    getUpperIdx() {
      ...
      else if (this.projTeamId == 6 || this.projTeamId == 7 || this.projTeamId == 8 || this.projTeamId == 9 || this.projTeamId == 10) {
        this.upperTeamIdx = 2
      }
      else if (this.projTeamId == 11 || this.projTeamId == 12 || this.projTeamId == 13) {
        this.upperTeamIdx = 3
      }
